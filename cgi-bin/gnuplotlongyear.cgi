...
set title "Temperature - 1/2 Year"
set ylabel "Temp (C)"
set xlabel "Date - 11year "
set grid
#set grid ytics
#set grid xtics
#set rmargin 15
#unset key
plot "< ./mysqldataxdays.sh $days" using 1:4 title "ute" with lines
#, "< ./mysqldataxdays.sh $days" using 1:3 title "inne" with lines
ENDOFINPUT
