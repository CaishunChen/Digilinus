...
$guestbookurl = "http://tomwre.dyndns.org/guestbook.html";
$guestbookreal = "/var/www/htdocs/guestbook.html";
$guestlog = "/var/www/htdocs/guestlog.html";
$cgiurl = "http://tomwre.dyndns.org/cgi-bin/guestbook.pl";
